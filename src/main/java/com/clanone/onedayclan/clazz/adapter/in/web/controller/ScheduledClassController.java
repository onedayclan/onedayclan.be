...
public class ScheduledClassController {
    ...
    public ResponseEntity<OnedayclanResponse<ScheduledClassDetailResponse>> getScheduledClassDetail(@LoginUserId String userId,
                                                                                                    @PathVariable long classSeq) {
        return ResponseEntity.ok(OnedayclanResponse.of(scheduledClassPort.getScheduledClassDetail(userId, classSeq)));
    }
